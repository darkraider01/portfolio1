        ...
        {data.githubRepos.length > 0 && (
          <div>
            <h3 className="text-lg font-semibold text-gray-800 mb-3">
              GitHub Repositories ({data.githubRepos.length})
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {data.githubRepos.slice(0, 6).map((repo, index) => (
            ...
            {data.githubRepos.length > 6 && (
              <p className="text-sm text-gray-500 mt-2">+{data.githubRepos.length - 6} more repositories</p>
            )}
          </div>
        )}
